...
4. สำรองข้อมูลจริงแบบเข้ารหัสอีกครั้งในช่วงหยุดทำรายการก่อน cutover และทดสอบกู้คืน สำเนาล่าสุดที่รวม staff ทั้ง 5 และตรวจถอดรหัสผ่านอยู่ที่ `/Users/keng/.codex/backups/chomdoi-house/2026-09-25T19-00-49-072Z-e3a0fa/`; เจ้าของระบบเลือกเก็บบน Mac เครื่องนี้เท่านั้น หากเครื่องและ Keychain สูญหายพร้อมกันอาจกู้จากสำเนานี้ไม่ได้

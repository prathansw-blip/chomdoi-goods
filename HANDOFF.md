...
| สถานะ release | Deploy Firebase Hosting และ secure Rules แล้วเมื่อ 26 กันยายน 2026 เวลา 10:43 น. ไทย; ยังไม่ merge เข้า `main`; เจ้าของรายงานว่า admin เข้าไม่ได้ กำลังตรวจสาเหตุ และยังไม่เปิดรับรายการ |
...
- **ยังไม่เปิดรับรายการ: เจ้าของระบบรายงานว่า `admin` เข้า webapp ไม่ได้** บัญชี Auth เปิดใช้งานและ staff มีบทบาท admin แต่ข้อความผิดพลาดของหน้า login รวมทั้งรหัสผิดและการโหลดสิทธิ์ล้มเหลว จึงยังไม่ยืนยันสาเหตุ กำลังตรวจแยก Firebase Auth, staff, staff directory และ store โดยให้เจ้าของกรอกรหัสในหน้าส่วนตัวบน Mac ยังไม่มีการเปลี่ยนรหัสผ่าน ณ บันทึกนี้ ไม่มีรายการขายจำลองหรือการแก้สต็อกถูกเขียนลง Production ระหว่าง smoke test; การทดสอบธุรกรรมพร้อมกันใช้ Emulator
...
- หลัง admin ผ่าน ให้ทุกเครื่องปิดแท็บเว็บเก่าแล้วเปิด URL เดิมเพื่อใช้รุ่นใหม่ **อย่าล้าง Chrome data** จนกว่าจะกระทบยอดข้อมูลเก่า การเปิดแท็บเก่าค้างไว้ไม่ทำให้ได้โค้ดใหม่ และ client เดิมจะถูกกฎใหม่ปฏิเสธการเขียน
